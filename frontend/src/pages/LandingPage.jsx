...
function ProductPreview() {
  return (
    <div className="relative mx-auto w-full max-w-xl" aria-hidden="true">
      ...
      <div className="relative rounded-2xl border border-white/10 bg-slate-950/70 p-3 shadow-2xl backdrop-blur-xl sm:p-4">
        ...
        <div className="p-3 sm:p-5">
          ...
          <div className="mt-5 rounded-xl border border-white/10 bg-white/[0.03]">
      ...
      <div className="absolute -bottom-7 -left-3 rounded-xl border border-white/10 bg-slate-900/95 px-4 py-3 shadow-xl sm:-left-8">
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <main id="main-content">
        <section className="relative overflow-hidden border-b border-white/10 bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950/70">
          ...
          <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-5 py-16 sm:px-6 sm:py-24 lg:grid-cols-2 lg:px-8 lg:py-28">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <div className="mt-9 flex flex-col items-stretch justify-center gap-4 sm:flex-row sm:items-center lg:justify-start">
                ...
                <a
                  href={`mailto:eddiejdev@gmail.com?subject=${encodeURIComponent(
                    'Gener8 Inventory Access Request',
                  )}`}
            ...
            <div className="px-3 pb-8 pt-5 sm:px-8 lg:px-0 lg:pb-0">
              <ProductPreview />
              <p className="sr-only">
                Example interface showing inventory totals, lot counts, project
                access levels, and inventory status using fictional data.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600">
                Gener8 Inventory is designed to provide useful project visibility
                without exposing unrelated customer or administrative data.
              </p>
            </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
              <div>
                ...
                <p className="mt-4 max-w-xl leading-7 text-slate-400">
                  The experience adapts to the access assigned to each account,
                  from operational inventory work to project visibility.
                </p>
              </div>
      ...
      <footer className="border-t border-white/10 bg-slate-950">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 py-7 text-center sm:px-6 md:flex-row md:text-left lg:px-8">
          <div className="flex items-center gap-2.5">
            <img src={logoG8} alt="" className="h-7 w-7" />
          ...
          >
            <a
              ...
              className="rounded text-slate-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
              Help & Support
            </a>
            <Link
          ...
          <p className="text-xs text-slate-500">© {year} Gener8</p>
        </div>
      </footer>
    </div>
  );
